...
function market_stocks = hist_SP500_daily_stock_data()
    start_date = '03011950';
    end_date   = '09022015';
    ...
    if status % Only do this on success
        ...
        market_stocks(1).Date = date; % Data date
        market_stocks(1).AdjClose = str2double(adj_close); % Adjusted Closing Price
    end
